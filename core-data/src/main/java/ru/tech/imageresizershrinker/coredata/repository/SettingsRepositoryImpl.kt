package ru.tech.imageresizershrinker.coredata.repository
...
import ru.tech.imageresizershrinker.coredata.keys.Keys.ADD_ORIGINAL_NAME_TO_FILENAME
import ru.tech.imageresizershrinker.coredata.keys.Keys.ADD_SEQ_NUM_TO_FILENAME
import ru.tech.imageresizershrinker.coredata.keys.Keys.ADD_SIZE_TO_FILENAME
import ru.tech.imageresizershrinker.coredata.keys.Keys.ALLOW_ANALYTICS
import ru.tech.imageresizershrinker.coredata.keys.Keys.ALLOW_BETAS
import ru.tech.imageresizershrinker.coredata.keys.Keys.ALLOW_CRASHLYTICS
import ru.tech.imageresizershrinker.coredata.keys.Keys.ALLOW_IMAGE_MONET
import ru.tech.imageresizershrinker.coredata.keys.Keys.AMOLED_MODE
import ru.tech.imageresizershrinker.coredata.keys.Keys.APP_COLOR_TUPLE
import ru.tech.imageresizershrinker.coredata.keys.Keys.APP_OPEN_COUNT
import ru.tech.imageresizershrinker.coredata.keys.Keys.AUTO_CACHE_CLEAR
import ru.tech.imageresizershrinker.coredata.keys.Keys.BORDER_WIDTH
import ru.tech.imageresizershrinker.coredata.keys.Keys.COLOR_TUPLES
import ru.tech.imageresizershrinker.coredata.keys.Keys.COPY_TO_CLIPBOARD
import ru.tech.imageresizershrinker.coredata.keys.Keys.DRAW_APPBAR_SHADOWS
import ru.tech.imageresizershrinker.coredata.keys.Keys.DRAW_BUTTON_SHADOWS
import ru.tech.imageresizershrinker.coredata.keys.Keys.DRAW_CONTAINER_SHADOWS
import ru.tech.imageresizershrinker.coredata.keys.Keys.DRAW_FAB_SHADOWS
import ru.tech.imageresizershrinker.coredata.keys.Keys.DRAW_SLIDER_SHADOWS
import ru.tech.imageresizershrinker.coredata.keys.Keys.DRAW_SWITCH_SHADOWS
import ru.tech.imageresizershrinker.coredata.keys.Keys.DYNAMIC_COLORS
import ru.tech.imageresizershrinker.coredata.keys.Keys.EMOJI_COUNT
import ru.tech.imageresizershrinker.coredata.keys.Keys.FAB_ALIGNMENT
import ru.tech.imageresizershrinker.coredata.keys.Keys.FILENAME_PREFIX
import ru.tech.imageresizershrinker.coredata.keys.Keys.FILENAME_SUFFIX
import ru.tech.imageresizershrinker.coredata.keys.Keys.FONT_SCALE
import ru.tech.imageresizershrinker.coredata.keys.Keys.GROUP_OPTIONS_BY_TYPE
import ru.tech.imageresizershrinker.coredata.keys.Keys.IMAGE_PICKER_MODE
import ru.tech.imageresizershrinker.coredata.keys.Keys.INVERT_THEME
import ru.tech.imageresizershrinker.coredata.keys.Keys.LOCK_DRAW_ORIENTATION
import ru.tech.imageresizershrinker.coredata.keys.Keys.NIGHT_MODE
import ru.tech.imageresizershrinker.coredata.keys.Keys.OVERWRITE_FILE
import ru.tech.imageresizershrinker.coredata.keys.Keys.PRESETS
import ru.tech.imageresizershrinker.coredata.keys.Keys.RANDOMIZE_FILENAME
import ru.tech.imageresizershrinker.coredata.keys.Keys.SAVE_FOLDER_URI
import ru.tech.imageresizershrinker.coredata.keys.Keys.SCREEN_ORDER
import ru.tech.imageresizershrinker.coredata.keys.Keys.SCREEN_SEARCH_ENABLED
import ru.tech.imageresizershrinker.coredata.keys.Keys.SELECTED_EMOJI_INDEX
import ru.tech.imageresizershrinker.coredata.keys.Keys.SELECTED_FONT_INDEX
import ru.tech.imageresizershrinker.coredata.keys.Keys.SHOW_UPDATE_DIALOG
import ru.tech.imageresizershrinker.coredata.keys.Keys.THEME_CONTRAST_LEVEL
import ru.tech.imageresizershrinker.coredata.keys.Keys.THEME_STYLE
import ru.tech.imageresizershrinker.coredata.keys.Keys.VIBRATION_STRENGTH
