...
@FilterInject
internal class RandomColorArrayFilter(
    override val value: GmicFilterParams = GmicFilterParams(
        values = listOf("5", "5", "0.5")
    )
) : GMICFilterTransformation(), Filter.RandomColorArray {

    override val cacheKey: String
        get() = value.hashCode().toString()

    override fun createFilter(): GmicFilter = RandomColorArray(
