...
@FilterInject
internal class ShadowPatchFilter(
    override val value: GmicFilterParams = GmicFilterParams(
        values = listOf("0.7", "All")
    )
) : GMICFilterTransformation(), Filter.ShadowPatch {

    override val cacheKey: String
        get() = value.hashCode().toString()

    override fun createFilter(): GmicFilter = ShadowPatch(
        opacity = value[0].toFloat(),
