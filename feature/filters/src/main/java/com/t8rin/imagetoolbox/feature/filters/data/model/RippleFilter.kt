...
@FilterInject
internal class RippleFilter(
    override val value: Quad<Float, Float, Float, Float> = 5f to 16f qto (5f to 16f)
) : JhFilterTransformation(), Filter.Ripple {

    override val cacheKey: String
        get() = value.hashCode().toString()

    override fun createFilter(): JhFilter = RippleFilter().apply {
        xAmplitude = value.first
        xWavelength = value.second
        yAmplitude = value.third
        yWavelength = value.fourth
    }
