...
@FilterInject
internal class JpegArtifactsFilter(
    override val value: GmicFilterParams = GmicFilterParams(
        values = listOf("50")
    )
) : GMICFilterTransformation(), Filter.JpegArtifacts {

    override val cacheKey: String
        get() = value.hashCode().toString()

    override fun createFilter(): GmicFilter = JpegArtifacts(
        quality = value[0].toInt()
    )
