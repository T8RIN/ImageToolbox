...
package com.t8rin.imagetoolbox.texture_generation.presentation
...
fun TextureGenerationContent(
    ...
    val shareButton: @Composable () -> Unit = {
        ...
        ShareButton(
            onShare = component::shareTexture,
            onCopy = {
                component.cacheCurrentTexture(Clipboard::copy)
            },
            onEdit = {
                component.cacheCurrentTexture(
                    onComplete = {
    ...
    AdaptiveLayoutScreen(
            ...
            Box(
                ...
                Picture(
                    ...
                    modifier = Modifier
                        ...
                        .aspectRatio(component.textureSize.safeAspectRatio.animate()),
        ...
        controls = {
            Column(
                ...
                ResizeImageField(
                    imageInfo = derivedValueOf(
                        keys = arrayOf(component.textureSize),
                        calculation = {
                            ImageInfo(component.textureSize.width, component.textureSize.height)
                        }
                    ),
                    originalSize = null,
                    onWidthChange = component::setTextureWidth,
                    onHeightChange = component::setTextureHeight
                )
