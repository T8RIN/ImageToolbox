...
data class NeuralModel(
    ...
    val name: String = downloadLink.substringAfterLast("/").substringBefore("?"),
    val title: String,
    val description: Int?,
    val type: Type?,
    val speed: Speed?,
    ...
    companion object {
        val entries: List<NeuralModel> by lazy {
            listOf(
                NeuralModel(
                    downloadLink = res("enhance/fbcnn/fbcnn_color_fp16.onnx"),
                    title = "FBCNN Color",
                ...
                NeuralModel(
                    downloadLink = res("enhance/fbcnn/fbcnn_grey_fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/fbcnn/fbcnn_gray_double_fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/scunet/scunet_color-GAN.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/scunet/scunet_color-PSNR.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/scunet/scunet_gray_15_fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/scunet/scunet_gray_25_fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/scunet/scunet_gray_50_fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/scunet/scunet_color_15_fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/scunet/scunet_color_25_fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/scunet/scunet_color_50_fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/nanomodels/1x-AnimeUndeint-Compact-fp16.onnx"),
                    title = "Anime Undeint",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/nanomodels/1x-BroadcastToStudio_Compact-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/nanomodels/1x-RGB-max-Denoise-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/nanomodels/1x-WB-Denoise-fp16.onnx"),
                    title = "WB Denoise",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/nanomodels/1x-span-anime-pretrain-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/nanomodels/1xBook-Compact-fp16.onnx"),
                    title = "Book Scan",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/nanomodels/1xOverExposureCorrection_compact-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x-Anti-Aliasing-fp16.onnx"),
                    title = "Anti-Aliasing",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_ColorizerV2_22000G-fp16.onnx"),
                    title = "Colorizer",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_DeSharpen-fp16.onnx"),
                    title = "DeSharpen",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_DeEdge-fp16.onnx"),
                    title = "DeEdge",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_GainresV4-fp16.onnx"),
                    title = "GainRes",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x-DeBink-v4.onnx"),
                    title = "DeBink v4",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x-DeBink-v5.onnx"),
                    title = "DeBink v5",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x-DeBink-v6.onnx"),
                    title = "DeBink v6",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x-KDM003-scans-fp16.onnx"),
                    title = "KDM003 Scans",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x-NMKD-Jaywreck3-Lite-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x-SpongeColor-Lite-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x-cinepak-fp16.onnx"),
                    title = "Cinepak",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_BCGone-DetailedV2_40-60_115000_G-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_BCGone_Smooth_110000_G-fp16.onnx"),
                    title = "BCGone Smooth",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_Bandage-Smooth-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_Bendel_Halftone-fp32.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_DitherDeleterV3-Smooth-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_JPEGDestroyerV2_96000G-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_NMKD-h264Texturize-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/VHS-Sharpen-1x_46000_G-fp16.onnx"),
                    title = "VHS Sharpen",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_artifacts_dithering_alsa-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_NMKD-BrightenRedux_200k-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_nmkdbrighten_10000_G-fp16.onnx"),
                    title = "NMKD Brighten",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_NMKDDetoon_97500_G-fp16.onnx"),
                    title = "NMKD Detoon",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_NoiseToner-Poisson-Detailed_108000_G-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_NoiseToner-Poisson-Soft_101000_G-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_NoiseToner-Uniform-Detailed_100000_G-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_NoiseToner-Uniform-Soft_100000_G-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_Repainter_20000_G-fp16.onnx"),
                    title = "Repainter",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x-Debandurh-FS-Ultra-lite-fp16.onnx"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_JPEG_00-20.ort"),
                    title = "JPEG 0-20",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_JPEG_20-40.ort"),
                    title = "JPEG 20-40",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_JPEG_40-60.ort"),
                    title = "JPEG 40-60",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_JPEG_60-80.ort"),
                    title = "JPEG 60-80",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_JPEG_80-100.ort"),
                    title = "JPEG 80-100",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_DeBLR.ort"),
                    title = "DeBLR",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_artifacts_jpg_00_20_alsa-fp16.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_artifacts_jpg_20_40_alsa-fp16.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_artifacts_jpg_40_60_alsa-fp16.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_artifacts_jpg_60_80_alsa-fp16.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_artifacts_jpg_80_100_alsa-fp16.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_ReDetail_v2_126000_G-fp16.ort"),
                    title = "ReDetail v2",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x-ITF-SkinDiffDetail-Lite-v1.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_SBDV-DeJPEG-Lite_130000_G.ort"),
                    title = "SBDV DeJPEG",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_ISO_denoise_v1.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/1x_DeJumbo.ort"),
                    title = "DeJumbo",
                ...
                NeuralModel(
                    downloadLink = res("enhance/other-models/ddcolor_paper_tiny.ort"),
                    title = "DDColor Tiny",
                ...
                NeuralModel(
                    downloadLink = res("enhance/upscale/RealESRGAN-x4v3.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/upscale/RealESRGAN_x2plus.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/upscale/RealESRGAN_x4plus.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/upscale/RealESRGAN_x4plus_anime_6B.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/upscale/RealESRNet_x4plus.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/upscale/RealESRGAN_x4plus_anime_4B32F.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/upscale/x4-UltraSharpV2_fp32_op17.ort"),
                ...
                NeuralModel(
                    downloadLink = res("enhance/upscale/x4-UltraSharpV2_Lite_fp16_op17.ort"),
                ...
                NeuralModel(
                    downloadLink = res("bgremove/RMBG_1.4.ort"),
                    title = "RMBG 1.4",
                ...
                NeuralModel(
                    downloadLink = res("bgremove/inspyrenet.onnx"),
                    title = "InSPyReNet",
                ...
                NeuralModel(
                    downloadLink = res("bgremove/u2net.onnx"),
                    title = "U2Net",
                ...
                NeuralModel(
                    downloadLink = res("bgremove/u2netp.onnx"),
                    title = "U2NetP",
                ...
                NeuralModel(
                    downloadLink = res("ddcolor_modelscope.onnx?download=true"),
                    title = "DDColor",
                ...
                NeuralModel(
                    downloadLink = res("ddcolor_artistic.onnx?download=true"),
                ...
                NeuralModel(
                    downloadLink = res("birefnet_swin_tiny.ort?download=true"),
                    title = "BiRefNet",
                ...
                NeuralModel(
                    downloadLink = res("isnet-general-use.onnx?download=true"),
                    title = "ISNet",
                ...
                NeuralModel(
                    downloadLink = res("upscalers/1x-Fatality-DeBlur.onnx?download=true"),
                ...
                NeuralModel(
                    downloadLink = res("upscalers/1x-UnResize-V3.onnx?download=true"),
                    title = "UnResize V3",
                ...
                NeuralModel(
                    downloadLink = res("upscalers/2xLiveActionV1_SPAN_490000.onnx?download=true"),
                ...
                NeuralModel(
                    downloadLink = res("upscalers/2xVHS2HD-RealPLKSR.onnx?download=true"),
                    title = "VHS to HD x2",
                ...
                NeuralModel(
                    downloadLink = res("upscalers/2x_Text2HD_v.1-RealPLKSR.onnx?download=true"),
                    title = "Text2HD x2",
                ...
                NeuralModel(
                    downloadLink = res("upscalers/4x-FrankendataPretrainer_SRFormer400K.onnx?download=true"),
                    title = "SRFormer x4",
                ...
                NeuralModel(
                    downloadLink = res("upscalers/4xRealWebPhoto_v2_rgt_s.onnx?download=true"),
                ...
                NeuralModel(
                    downloadLink = res("upscalers/4xRealWebPhoto_v4_dat2.onnx?download=true"),
                ...
                NeuralModel(
                    downloadLink = res("upscalers/DAT_2_x2.onnx?download=true"),
                    title = "DAT2 x2",
                ...
                NeuralModel(
                    downloadLink = res("upscalers/DAT_2_x3.onnx?download=true"),
                    title = "DAT2 x3",
                ...
                NeuralModel(
                    downloadLink = res("upscalers/DAT_2_x4.onnx?download=true"),
                    title = "DAT2 x4",
                ...
                NeuralModel(
                    downloadLink = res("deblurring_nafnet_2025may.onnx?download=true"),
                ...
                NeuralModel(
                    downloadLink = res("upscalers/swin2SR-x4-bsrgan-psnr.onnx?download=true"),
                ...
                NeuralModel(
                    downloadLink = res("upscalers/BSRGAN_SwinIR-M_x4_GAN.onnx?download=true"),
                ...
                NeuralModel(
                    downloadLink = res("upscalers/RealESR-AnimeVideo-x4v3.onnx?download=true"),
        ...
        private fun res(path: String): String = if ("?download=true" in path) {
            HF_BASE_URL.replace("*", path)
        } else {
            RES_BASE_URL.replace("*", "onnx/$path")
        }
    }
