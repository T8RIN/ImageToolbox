...
package com.t8rin.imagetoolbox.feature.pdf_tools.presentation.dark_mode.screenLogic
...
class PdfDarkModeToolComponent @AssistedInject internal constructor(
    ...
    override fun getKey(): Pair<String, Uri?> = "dark_mode" to uri
