...
package com.t8rin.imagetoolbox.feature.pdf_tools.presentation.sanitize.screenLogic
...
class SanitizePdfToolComponent @AssistedInject internal constructor(
    ...
    val uri by _uri
    private val _params = mutableStateOf(PdfSanitizeParams())
    ...
    override fun getKey(): Pair<String, Uri?> = "sanitized" to uri
    ...
    fun updateParams(params: PdfSanitizeParams) {
        _params.value = params
        registerChanges()
    }

    private suspend fun process(): Uri = pdfManager.sanitizePdf(
        uri = uri.toString(),
        params = params
    ).toUri()
