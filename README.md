...
| </br> ![Boosty](https://img.shields.io/badge/Boosty-F15F2C?style=for-the-badge&logo=Boosty&logoColor=white) <br/> <br/> [https://boosty.to/t8rin](https://boosty.to/t8rin) <br/> <br/> | </br> ![TON](https://img.shields.io/badge/TON%20DeFI-0098EA?style=for-the-badge&logo=TON&logoColor=white) <br/> <br/> `UQDMePBU-FaxwaIME8p7h2spRITeRxvtCPegtKefeV5v-sN1` <br/> <br/> |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
...
- Code Preview Generator
    ...
    - Choose from 46 syntax themes and 30 gradient backgrounds, or use custom colors and
      transparency
    - Customize canvas spacing, rounded corners, rotation, window controls, line numbers and card
      shadow
    - Export in multiple image formats or share and edit the generated image directly
- Archive Tools
...
- Additional Features
    ...
    - Reusable export profiles for Single Edit and Resize & Convert
      - 61 built-in profiles for web publishing and popular social platforms
