    ...
    get() {
        ...
        _lipstick = Builder(name = "Lipstick", defaultWidth = 1.0.dp, defaultHeight = 1.0.dp,
            ...
            path(fill = SolidColor(Color(0xFFC62828)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(6.02f, -0.55f, 11.45f, 1.47f, 17.97f, 5.83f)
                curveToRelative(9.38f, 6.27f, 16.96f, 16.09f, 16.96f, 26.11f)
                verticalLineToRelative(44.34f)
                reflectiveCurveTo(80.91f, 81.95f, 64.0f, 81.95f)
            ...
            path(fill = SolidColor(Color(0xFFF44336)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(79.16f, 12.24f, 61.19f, 2.26f, 53.21f, 4.25f)
            ...
            path(fill = SolidColor(Color(0xFFFF8383)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-3.39f, -4.07f, -5.37f, -9.4f, -5.0f, -14.68f)
                curveToRelative(0.12f, -1.66f, 0.85f, -4.47f, 2.07f, -6.35f)
                curveToRelative(0.51f, -0.79f, 0.86f, -0.42f, 0.7f, 0.74f)
                curveToRelative(-0.67f, 4.9f, 0.77f, 9.27f, 2.11f, 12.19f)
            ...
            path(fill = SolidColor(Color(0xFFE2A610)), stroke = null, strokeLineWidth = 0.0f,
                ...
                verticalLineTo(80.02f)
                lineToRelative(58.93f, -0.07f)
            ...
            path(fill = SolidColor(Color(0xFFA12524)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(3.3f, 7.42f, 23.38f, 5.81f)
                curveToRelative(21.39f, -1.71f, 24.53f, -12.42f, 24.53f, -12.42f)
            ...
            path(fill = SolidColor(Color(0xFFFFCA28)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 0.0f, -5.47f, 2.16f, -5.47f, 3.26f)
                curveToRelative(0.0f, 2.77f, 13.19f, 5.02f, 29.47f, 5.02f)
                reflectiveCurveToRelative(29.47f, -2.25f, 29.47f, -5.02f)
            ...
            path(fill = SolidColor(Color(0xFFFFF59D)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(1.94f, 0.22f, 2.22f, 0.43f, 6.1f, 0.81f)
                curveToRelative(4.53f, 0.44f, 7.92f, 0.44f, 6.85f, 1.79f)
            ...
            path(fill = SolidColor(Color(0xFF424242)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(0.04f, 21.82f)
                curveTo(28.83f, 121.41f, 44.64f, 124.0f, 64.0f, 124.0f)
                reflectiveCurveToRelative(35.17f, -2.59f, 36.14f, -5.85f)
            ...
            path(fill = SolidColor(Color(0xFF757575)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 0.0f, -6.71f, 2.65f, -6.71f, 4.0f)
                curveToRelative(0.0f, 3.4f, 16.2f, 6.16f, 36.19f, 6.16f)
                reflectiveCurveToRelative(36.19f, -2.76f, 36.19f, -6.16f)
            ...
            path(fill = SolidColor(Color(0xFF90A4AE)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(2.95f, 0.51f, 7.32f, 1.37f, 17.77f, 1.49f)
                curveToRelative(3.13f, 0.03f, 3.29f, 1.08f, 3.09f, 1.75f)
                curveToRelative(-0.28f, 0.95f, -1.57f, 1.29f, -7.94f, 1.46f)
                close()
            }
        }
        .build()
