...
public val Emoji.Eyes: ImageVector
    get() {
        ...
        _eyes = Builder(name = "Eyes", defaultWidth = 1.0.dp, defaultHeight = 1.0.dp, viewportWidth
            ...
            path(fill = SolidColor(Color(0xFFB0BEC5)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0xFF424242), 1.0f to Color(0xFF212121), start =
                    Offset(22.523f,46.676f), end = Offset(22.523f,82.083f)), stroke = null,
            ...
            path(fill = linearGradient(0.0f to Color(0xFF424242), 1.0f to Color(0xFF212121), start =
                    Offset(82.209f,46.676f), end = Offset(82.209f,82.083f)), stroke = null,
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
