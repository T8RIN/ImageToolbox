...
public val Emoji.Sunrise: ImageVector
    get() {
        ...
        _sunrise = Builder(
            name = "Sunrise", defaultWidth = 1.0.dp, defaultHeight = 1.0.dp,
            viewportWidth = 128.0f, viewportHeight = 128.0f
        ).apply {
            path(
                fill = radialGradient(
                    0.275f to Color(0xFFFFD0AF),
                    0.372f to Color(0xFFFFC7AB),
                    0.529f to Color(0xFFFFAFA0),
                    0.631f to Color(0xFFFF9C97),
                    0.702f to
                            Color(0xFFFF947A),
                    0.79f to Color(0xFFFF8C5A),
                    0.865f to Color(0xFFFC895C),
                    0.928f to Color(0xFFF47E62),
                    0.987f to Color(0xFFE56D6D),
                    1.0f to
                            Color(0xFFE16870),
                    center = Offset(63.542f, 78.723f),
                    radius = 88.912f
                ), stroke =
            ...
            path(
                fill = SolidColor(Color(0xFFFFF7B3)), stroke = null, strokeLineWidth = 0.0f,
            ...
            path(
                fill = SolidColor(Color(0xFFFFFDFA)), stroke = null, strokeLineWidth = 0.0f,
                strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                pathFillType = NonZero
            ) {
            ...
            path(
                fill = radialGradient(
                    0.0f to Color(0xFFFFF7B3),
                    0.046f to Color(0xFFFFF29E),
                    0.155f to Color(0xFFFFE873),
                    0.261f to Color(0xFFFFE051),
                    0.36f to
                            Color(0xFFFFDA39),
                    0.452f to Color(0xFFFFD62A),
                    0.528f to Color(0xFFFFD525),
                    0.975f to Color(0x0DFFD525),
                    1.0f to Color(0x00FFD525),
                    center =
                    Offset(35.001f, 77.736f),
                    radius = 32.437f
            ...
            path(
                fill = radialGradient(
                    ...
                    0.452f to Color(0xFFFFD62A),
                    0.528f to Color(0xFFFFD525),
                    0.906f to Color(0x00FFD525),
                    center = Offset(34.733f, 70.686f),
                    radius =
                    36.905f
            ...
            path(
                fill = radialGradient(
                    ...
                    0.452f to Color(0xFFFFD62A),
                    0.528f to Color(0xFFFFD525),
                    0.897f to Color(0x00FFD525),
                    center = Offset(38.928f, 59.148f),
                    radius =
                    44.193f
                ), stroke = null, strokeLineWidth = 0.0f, strokeLineCap = Butt,
                strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero
            ...
            path(
                fill = radialGradient(
                    0.0f to Color(0xFFFFF7B3),
                    0.033f to Color(0xFFFFF29E),
                    0.111f to Color(0xFFFFE873),
                    0.186f to Color(0xFFFFE051),
                    0.258f to
                            Color(0xFFFFDA39),
                    0.324f to Color(0xFFFFD62A),
                    0.378f to Color(0xFFFFD525),
                    0.757f to Color(0x00FFD525),
                    center = Offset(41.779f, 49.682f),
                    radius =
                    51.324f
                ), stroke = null, strokeLineWidth = 0.0f, strokeLineCap = Butt,
                strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero
            ...
            path(
                fill = radialGradient(
                    ...
                    0.452f to Color(0xFFFFD62A),
                    0.528f to Color(0xFFFFD525),
                    0.854f to Color(0x00FFD525),
                    center = Offset(44.695f, 50.914f),
                    radius =
                    50.513f
                ), stroke = null, strokeLineWidth = 0.0f, strokeLineCap = Butt,
                strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero
            ...
            path(
                fill = radialGradient(
                    ...
                    0.452f to Color(0xFFFFD62A),
                    0.528f to Color(0xFFFFD525),
                    0.976f to Color(0x00FFD525),
                    center = Offset(56.16f, 45.789f),
                    radius = 42.264f
                ),
            ...
            path(
                fill = radialGradient(
                    0.0f to Color(0xFFFFF7B3),
                    0.04f to Color(0xFFFFF29E),
                    0.133f
                            to Color(0xFFFFE873),
                    0.224f to Color(0xFFFFE051),
                    0.309f to Color(0xFFFFDA39),
                    0.388f to Color(0xFFFFD62A),
                    0.453f to Color(0xFFFFD525),
                    0.959f to
                            Color(0x00FFD525),
                    center = Offset(73.378f, 46.619f),
                    radius = 44.476f
                ), stroke =
                null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                strokeLineMiter = 4.0f, pathFillType = NonZero
            ...
            path(
                fill = radialGradient(
                    ...
                    0.452f to Color(0xFFFFD62A),
                    0.528f to Color(0xFFFFD525),
                    0.926f to Color(0x00FFD525),
                    center = Offset(81.468f, 49.523f),
                    radius =
                    47.227f
                ), stroke = null, strokeLineWidth = 0.0f, strokeLineCap = Butt,
                strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero
            ...
            path(
                fill = radialGradient(
                    0.0f to Color(0xFFFFF7B3),
                    0.037f to Color(0xFFFFF29E),
                    0.126f to Color(0xFFFFE873),
                    0.212f to Color(0xFFFFE051),
                    0.293f to
                            Color(0xFFFFDA39),
                    0.368f to Color(0xFFFFD62A),
                    0.43f to Color(0xFFFFD525),
                    0.832f to Color(0x00FFD525),
                    center = Offset(85.311f, 52.263f),
                    radius =
                    49.025f
                ), stroke = null, strokeLineWidth = 0.0f, strokeLineCap = Butt,
                strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero
            ...
            path(
                fill = radialGradient(
                    ...
                    0.452f to Color(0xFFFFD62A),
                    0.528f to Color(0xFFFFD525),
                    0.942f to Color(0x00FFD525),
                    center = Offset(94.537f, 82.092f),
                    radius =
                    31.836f
                ), stroke = null, strokeLineWidth = 0.0f, strokeLineCap = Butt,
                strokeLineJoin = Miter, strokeLineMiter = 4.0f, pathFillType = NonZero
            ...
            path(
                fill = radialGradient(
                    0.246f to Color(0xFFCAD7A8),
                    0.34f to Color(0xFFC5D6AA),
                    0.457f to Color(0xFFB5D4B0),
                    0.587f to Color(0xFF9CD1B9),
                    0.724f to
                            Color(0xFF79CDC6),
                    0.867f to Color(0xFF4CC7D6),
                    0.997f to Color(0xFF1DC1E8),
                    center = Offset(65.22744f, 68.51817f),
                    radius = 54.924046f
                ), stroke = null,
            ...
            path(
                fill = SolidColor(Color(0xFFBAF3FA)), stroke = null, strokeLineWidth = 0.0f,
                strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                pathFillType = NonZero
            ) {
