...
public val Emoji.Disk: ImageVector
    get() {
        if (_disk != null) {
            return _disk!!
        }
        _disk = Builder(name = "Disk", defaultWidth = 1.0.dp, defaultHeight = 1.0.dp, viewportWidth
                = 128.0f, viewportHeight = 128.0f).apply {
            path(fill = SolidColor(Color(0xFFB9E4EA)), stroke = null, strokeLineWidth = 0.0f,
            ...
            path(fill = linearGradient(0.0f to Color(0x99FFF9C4), 0.95f to Color(0x00FFF9C4), start
                    = Offset(34.657f,44.491f), end = Offset(31.029f,50.352f)), stroke = null,
            ...
            path(fill = linearGradient(0.0f to Color(0x99FFF9C4), 0.989f to Color(0x01FFF9C4), 1.0f
                    to Color(0x00FFF9C4), start = Offset(38.141f,40.904f), end =
                    Offset(48.932f,31.695f)), stroke = null, strokeLineWidth = 0.0f, strokeLineCap =
            ...
            path(fill = linearGradient(0.0f to Color(0xCCFFC2C8), 0.93f to Color(0x00FFCDD2), start
                    = Offset(29.82969f,54.09692f), end = Offset(28.455832f,61.40844f)), stroke =
            ...
            path(fill = linearGradient(0.0f to Color(0xCCFFC2C8), 0.93f to Color(0x00FFCDD2), start
                    = Offset(30.630882f,50.436768f), end = Offset(38.62138f,38.657455f)), stroke =
                    null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0x7F80DEEA), 0.926f to Color(0x0080DEEA), start
                    = Offset(45.492f,33.598f), end = Offset(39.352f,38.202f)), stroke = null,
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(28.4f, 19.46f)
            ...
            path(fill = linearGradient(0.0f to Color(0x7F80DEEA), 0.947f to Color(0x0080DEEA), start
                    = Offset(53.405f,31.356f), end = Offset(63.451f,28.659f)), stroke = null,
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0x7FFFFFFF), 0.907f to Color(0x00FFFFFF), start
                    = Offset(96.534f,49.734f), end = Offset(99.371f,60.432f)), stroke = null,
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0x7FFFFFFF), 0.907f to Color(0x00FFFFFF), start
                    = Offset(93.391f,45.481f), end = Offset(91.112f,41.481f)), stroke = null,
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0x7FFFFFFF), 0.907f to Color(0x00FFFFFF), start
                    = Offset(36.143f,84.388f), end = Offset(37.352f,86.341f)), stroke = null,
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0x7FFFFFFF), 0.907f to Color(0x00FFFFFF), start
                    = Offset(32.583f,80.69f), end = Offset(28.862f,69.621f)), stroke = null,
                    strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(49.94f, 66.3f)
            ...
            path(fill = linearGradient(0.0f to Color(0x99FFF9C4), 0.95f to Color(0x00FFF9C4), start
                    = Offset(93.52714f,82.98142f), end = Offset(97.056755f,77.061646f)), stroke =
                    null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0x99FFF9C4), 0.989f to Color(0x01FFF9C4), 1.0f
                    ...
                    Offset(79.418175f,96.0939f)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0xCCFFC2C8), 0.93f to Color(0x00FFCDD2), start
                    = Offset(98.268814f,73.197105f), end = Offset(99.51959f,65.86259f)), stroke =
                    null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0xCCFFC2C8), 0.93f to Color(0x00FFCDD2), start
                    = Offset(97.50697f,77.01969f), end = Offset(89.71422f,88.92969f)), stroke =
                    null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0x7F80DEEA), 0.926f to Color(0x0080DEEA), start
                    = Offset(82.70892f,94.01565f), end = Offset(88.77015f,89.308754f)), stroke =
                    null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = linearGradient(0.0f to Color(0x7F80DEEA), 0.947f to Color(0x0080DEEA), start
                    = Offset(74.79534f,96.44216f), end = Offset(64.79581f,99.30757f)), stroke =
                    null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                    strokeLineMiter = 4.0f, pathFillType = NonZero) {
            ...
            path(fill = SolidColor(Color(0xFF6C9EB4)), stroke = null, fillAlpha = 0.4f, strokeAlpha
            ...
            path(fill = SolidColor(Color(0xFF82AEC0)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(64.0f, 9.86f)
