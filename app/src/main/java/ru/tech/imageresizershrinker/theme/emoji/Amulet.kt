...
public val Emoji.Amulet: ImageVector
    get() {
        if (_amulet != null) {
            return _amulet!!
        }
        _amulet = Builder(
            ...
            path(
                ...
                curveToRelative(2.85f, 33.01f, -22.82f, 60.0f, -55.96f, 60.0f)
            ...
            path(
                ...
                curveToRelative(-15.95f, 10.89f, -34.27f, 18.29f, -53.3f, 21.55f)
                curveToRelative(-4.18f, 0.72f, -17.9f, 2.94f, -19.68f, 10.84f)
                curveToRelative(-1.18f, 5.24f, 0.92f, 11.77f, 5.02f, 15.82f)
                curveToRelative(8.86f, 8.74f, 16.03f, 12.23f, 20.08f, 13.61f)
                curveToRelative(1.23f, 0.42f, 2.28f, -0.96f, 1.57f, -2.04f)
                curveToRelative(-1.23f, -1.86f, -2.5f, -4.03f, -2.22f, -4.69f)
                curveToRelative(1.67f, -3.91f, 10.88f, 1.96f, 16.32f, 2.92f)
                curveToRelative(12.24f, 2.15f, 16.94f, 0.06f, 25.03f, -2.44f)
                curveToRelative(2.28f, -0.7f, 6.56f, -2.71f, 8.6f, -1.59f)
                curveToRelative(2.37f, 1.3f, -2.43f, 6.64f, -5.54f, 9.74f)
                curveToRelative(-0.7f, 0.7f, 0.05f, 1.85f, 0.98f, 1.52f)
                curveToRelative(9.41f, -3.36f, 29.59f, -18.13f, 33.44f, -42.26f)
            ...
            path(
                ...
                curveToRelative(2.24f, 18.76f, -15.67f, 37.39f, -36.23f, 35.13f)
            ...
            path(
                ...
                curveToRelative(1.99f, 1.67f, 0.57f, 4.15f, -3.51f, 7.08f)
                curveToRelative(-6.64f, 4.75f, -7.84f, 11.34f, -13.82f, 10.13f)
                close()
                moveTo(21.8f, 36.42f)
                curveToRelative(5.37f, 0.73f, 0.01f, 8.34f, -1.95f, 10.05f)
                curveToRelative(-0.37f, 0.32f, -2.17f, 1.45f, -3.69f, 0.88f)
                reflectiveCurveToRelative(-1.07f, -3.62f, -0.82f, -4.76f)
                curveToRelative(0.64f, -2.87f, 2.85f, -6.66f, 6.46f, -6.17f)
                close()
            }
        }
            .build()
...
private var _amulet: ImageVector? = null
