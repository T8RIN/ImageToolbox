...
val Emoji.Warning: ImageVector
    get() {
        ...
        _warning = Builder(
            name = "Warning", defaultWidth = 1.0.dp, defaultHeight = 1.0.dp,
            ...
            path(
                fill = SolidColor(Color(0xFF424242)), stroke = null, fillAlpha = 0.2f, strokeAlpha
            ...
            path(
                fill = linearGradient(
                    ...
                    Offset(64.36f, 32.270035f), end = Offset(64.36f, 110.96004f)
                ), stroke = null,
            ...
            path(
                fill = linearGradient(
                    0.0f to Color(0xFF424242), 1.0f to Color(0xFF212121), start =
                    Offset(64.36f, 36.250015f), end = Offset(64.36f, 114.94002f)
                ), stroke = null,
                strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,
                strokeLineMiter = 4.0f, pathFillType = NonZero
            ) {
            ...
            path(
                fill = SolidColor(Color(0xFFFFF170)), stroke = null, strokeLineWidth = 0.0f,
                strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                pathFillType = NonZero
            ) {
