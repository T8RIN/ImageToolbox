 ...
 */ private constructor(
    ...
    companion object {
        ...
        fun make(
            ...
            val c = if (f >= 0.9) lerp(0.59, 0.69, (f - 0.9) * 10.0) else lerp(
                0.525,
                0.59,
                (f - 0.8) * 10.0
            )
