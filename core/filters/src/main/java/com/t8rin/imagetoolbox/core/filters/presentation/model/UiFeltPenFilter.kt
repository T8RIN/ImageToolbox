...
class UiFeltPenFilter(
    override val value: GmicFilterParams = GmicFilterParams(
        values = listOf("300", "50", "1", "0.1", "20", "5")
    )
) : GmicUiFilter(
    title = R.string.gmic_filter_felt_pen,
    value = value,
    gmicParamsInfo = listOf(
        GmicParameterInfo.Number(R.string.amplitude, 0f..4000f, isInteger = false),
        ...
        GmicParameterInfo.Number(R.string.texture_thickness, 2f..32f, isInteger = true)
    )
), Filter.FeltPen
