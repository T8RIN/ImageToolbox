...
class UiConcentricSquareBreaksFilter(
    override val value: ProceduralParams = ProceduralParams()
) : UiProceduralFilter(
    title = R.string.concentric_square_breaks,
    effect = ProceduralEffect.ConcentricSquareBreaks,
    value = value
), Filter.ConcentricSquareBreaks