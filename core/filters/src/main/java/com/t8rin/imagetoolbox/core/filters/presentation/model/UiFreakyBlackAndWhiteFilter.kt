...
class UiFreakyBlackAndWhiteFilter(
    override val value: GmicFilterParams = GmicFilterParams(
        values = listOf("90", "20", "0", "0", "0")
    )
) : GmicUiFilter(
    title = R.string.gmic_filter_freaky_black_and_white,
    value = value,
    gmicParamsInfo = listOf(
        GmicParameterInfo.Number(R.string.strength, 0f..100f, isInteger = false),
        GmicParameterInfo.Number(R.string.gmic_param_oddness_percent, 0f..100f, isInteger = false),
