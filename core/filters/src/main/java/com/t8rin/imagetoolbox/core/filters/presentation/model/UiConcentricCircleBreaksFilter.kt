...
class UiConcentricCircleBreaksFilter(
    override val value: ProceduralParams = ProceduralParams()
) : UiProceduralFilter(
    title = R.string.concentric_circle_breaks,
    effect = ProceduralEffect.ConcentricCircleBreaks,
    value = value
), Filter.ConcentricCircleBreaks