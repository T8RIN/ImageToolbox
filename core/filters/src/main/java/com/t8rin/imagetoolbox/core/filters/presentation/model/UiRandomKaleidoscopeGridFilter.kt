...
class UiRandomKaleidoscopeGridFilter(
    override val value: ProceduralParams = ProceduralParams()
) : UiProceduralFilter(
    title = R.string.random_kaleidoscope_grid,
    effect = ProceduralEffect.RandomKaleidoscopeGrid,
    value = value
), Filter.RandomKaleidoscopeGrid