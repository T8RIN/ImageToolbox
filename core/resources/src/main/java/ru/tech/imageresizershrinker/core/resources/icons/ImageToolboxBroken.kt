...
val Icons.Outlined.ImageToolboxBroken: ImageVector by lazy {
    ImageVector.Builder(
        ...
        path(fill = SolidColor(Color(0xFF000000))) {
            moveTo(695.4f, 710.2f)
            curveToRelative(-4.3f, 3.9f, -8.6f, 7.9f, -12.8f, 11.8f)
            curveTo(597.8f, 799.8f, 519.7f, 871.4f, 451.9f, 829.4f)
            lineToRelative(-69.4f, -42.7f)
            curveToRelative(-81.2f, -46.8f, -176.2f, 22.4f, -267.9f, 89.2f)
