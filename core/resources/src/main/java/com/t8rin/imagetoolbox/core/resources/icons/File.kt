...
val Icons.Rounded.File: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Rounded.File",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
...
val Icons.Outlined.File: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Outlined.File",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
...
val Icons.TwoTone.File: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "TwoTone.File",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
