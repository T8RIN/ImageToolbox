...
val Icons.Rounded.EmojiSymbols: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Rounded.EmojiSymbols",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 960f,
        viewportHeight = 960f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveQuadTo(418f, 668f)
            quadToRelative(11f, 12f, 11.5f, 28f)
            reflectiveQuadTo(418f, 724f)
            lineToRelative(-28f, 28f)
            lineToRelative(28f, 28f)
            quadToRelative(11f, 11f, 11f, 28f)
            reflectiveQuadToRelative(-11f, 28f)
