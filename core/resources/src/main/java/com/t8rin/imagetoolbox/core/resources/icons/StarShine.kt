...
val Icons.Rounded.StarShine: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Rounded.StarShine",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 960f,
        viewportHeight = 960f
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(788.5f, 588f)
            quadToRelative(16.5f, 0f, 28.5f, 12f)
            ...
            close()
            moveTo(812f, 148.5f)
            quadToRelative(0f, 16.5f, -12f, 28.5f)
