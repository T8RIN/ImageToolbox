...
val Icons.Outlined.GifBox: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        ...
        path(fill = SolidColor(Color.Black)) {
            moveTo(12.288f, 14.787f)
            curveToRelative(0.142f, -0.142f, 0.213f, -0.321f, 0.213f, -0.538f)
...
val Icons.TwoTone.GifBox: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "TwoTone.GifBox",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
...
val Icons.Rounded.GifBox: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Rounded.GifBox",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            lineTo(200f, 840f)
            close()
            moveTo(491.5f, 591.5f)
            quadTo(500f, 583f, 500f, 570f)
            ...
            quadToRelative(13f, 0f, 21.5f, -8.5f)
            reflectiveQuadTo(700f, 490f)
            quadToRelative(0f, -13f, -8.5f, -21.5f)
            reflectiveQuadTo(670f, 460f)
            horizontalLineToRelative(-50f)
