...
val Icons.Rounded.Extension: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
val Icons.Outlined.Extension: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Outlined.Extension",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 960f,
        viewportHeight = 960f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            quadToRelative(24f, -66f, 77f, -93f)
            reflectiveQuadToRelative(98f, -27f)
            quadToRelative(45f, 0f, 98f, 27f)
            reflectiveQuadToRelative(77f, 93f)
            horizontalLineToRelative(85f)
