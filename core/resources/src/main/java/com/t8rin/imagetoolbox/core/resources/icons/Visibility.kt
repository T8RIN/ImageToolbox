...
val Icons.Rounded.Visibility: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
val Icons.Outlined.Visibility: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Outlined.Visibility",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 960f,
        viewportHeight = 960f
