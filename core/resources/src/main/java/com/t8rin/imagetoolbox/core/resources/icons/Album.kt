...
val Icons.Outlined.Album: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Outlined.Album",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
...
val Icons.Rounded.Album: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Rounded.Album",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
...
val Icons.TwoTone.Album: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "TwoTone.Album",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            reflectiveCurveToRelative(1.313f, -1.938f, 1.313f, -3.188f)
            reflectiveCurveToRelative(-0.438f, -2.313f, -1.313f, -3.188f)
            reflectiveCurveToRelative(-1.938f, -1.313f, -3.188f, -1.313f)
            reflectiveCurveToRelative(-2.313f, 0.438f, -3.188f, 1.313f)
            reflectiveCurveToRelative(-1.313f, 1.938f, -1.313f, 3.188f)
            reflectiveCurveToRelative(0.438f, 2.313f, 1.313f, 3.188f)
            reflectiveCurveToRelative(1.938f, 1.313f, 3.188f, 1.313f)
            close()
            moveTo(11.288f, 12.712f)
