...
val Icons.TwoTone.FileRename: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "TwoTone.FileRename",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black), fillAlpha = 0.3f) {
            moveTo(4f, 19f)
            horizontalLineToRelative(1.425f)
            lineToRelative(9.775f, -9.775f)
            lineToRelative(-1.425f, -1.425f)
