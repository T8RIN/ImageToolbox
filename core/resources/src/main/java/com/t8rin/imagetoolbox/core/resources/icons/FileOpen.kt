...
val Icons.Outlined.FileOpen: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
...
val Icons.Rounded.FileOpen: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Rounded.FileOpen",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 960f,
        viewportHeight = 960f
...
val Icons.TwoTone.FileOpen: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "TwoTone.FileOpen",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        path(fill = SolidColor(Color.Black)) {
            ...
            curveToRelative(0.183f, 0.183f, 0.275f, 0.412f, 0.275f, 0.688f)
            reflectiveCurveToRelative(-0.092f, 0.512f, -0.275f, 0.712f)
            curveToRelative(-0.2f, 0.2f, -0.438f, 0.3f, -0.712f, 0.3f)
            reflectiveCurveToRelative(-0.512f, -0.1f, -0.712f, -0.3f)
            lineToRelative(-2.225f, -2.225f)
            close()
            moveTo(6f, 20f)
            verticalLineTo(4f)
            verticalLineToRelative(16f)
